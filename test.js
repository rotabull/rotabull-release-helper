const closedPrResponseData = [
  {
    ...
    user: {
      ...
      starred_url: "https://api.github.com/users/Kysss/starred{/owner}{/repo}",
      ...
      received_events_url: "https://api.github.com/users/Kysss/received_events",
      type: "User",
      site_admin: false,
    },
    body:
  ...
  },
  {
    ...
    state: "closed",
    locked: false,
    title: "[ch3681] Properly display/download attachments from an email quote",
    user: {
      login: "ibarrae",
      id: 22796877,
  ...
  },
  {
    ...
    state: "closed",
    locked: false,
    title: "Change Quickbooks invoice worker to run every 10 minutes [ch3644]",
    user: {
      ...
      gists_url: "https://api.github.com/users/benjaminsfrank/gists{/gist_id}",
      starred_url:
  ...
  },
  {
    ...
    user: {
      ...
      following_url: "https://api.github.com/users/dnwz/following{/other_user}",
      ...
      received_events_url: "https://api.github.com/users/dnwz/received_events",
      type: "User",
      site_admin: false,
    },
    body:
  ...
  },
  {
    ...
    user: {
      ...
      gists_url: "https://api.github.com/users/rotabull-keith/gists{/gist_id}",
      starred_url:
